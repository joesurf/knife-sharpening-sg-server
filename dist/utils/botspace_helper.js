import { getOrderConstants, getOrders, getCustomers180DaysOld, updateNotionCustomer180DayFollowUp, clearNotionCustomerReminderDate, getCustomersWithReminderDates, formatOrders, } from './notion_helper.js';
const BOTSPACE_COLLECTION_WEBHOOK_URL = 'https://hook.bot.space/ZHVAL4hD99ef/v1/webhook/automation/68da50444ce0c3f496978e79/flow/68e8a0a0f881d90a0c73f941';
const BOTSPACE_DELIVERY_WEBHOOK_URL = 'https://hook.bot.space/ZHVAL4hD99ef/v1/webhook/automation/68da50444ce0c3f496978e79/flow/68ecb2d0f881d90a0ce76bcc';
const BOTSPACE_180DAY_WEBHOOK_URL = 'https://hook.bot.space/ZHVAL4hD99ef/v1/webhook/automation/68da50444ce0c3f496978e79/flow/68ef568abf1d5ae4083e5a36';
const BOTSPACE_REMINDER_WEBHOOK_URL = 'https://hook.bot.space/ZHVAL4hD99ef/v1/webhook/automation/68da50444ce0c3f496978e79/flow/68eff0c8bf1d5ae40860a005';
const BOTSPACE_COLLECTED_WEBHOOK_URL = 'https://hook.bot.space/ZHVAL4hD99ef/v1/webhook/automation/68da50444ce0c3f496978e79/flow/693a92b06b270d7d55c66f9d';
const BOTSPACE_DELIVERED_WEBHOOK_URL = 'https://hook.bot.space/ZHVAL4hD99ef/v1/webhook/automation/68da50444ce0c3f496978e79/flow/69400ec469cb724b1ac191ad';
    ...
    orders.forEach(async (order) => {
        const orderBody = {
            name: order.properties['Customer Name'].rollup.array[0].title[0]
                .plain_text,
            phone: order.properties['Customer Phone'].rollup.array[0].phone_number.replaceAll(' ', ''),
            timing: timing,
        };
...
export { fetchBotspace, sendCollectionReminder, sendDeliveryReminder, send180DayReminder, sendRequestedReminder, sendCollectedMessage, sendDeliveredMessage, };
